...
namespace GigaFileBrowser.Internal.View
{
    public class FileBrowserView : MonoBehaviour
    {
        ...
        readonly Dictionary<Graphic, Color> initialColors = new Dictionary<Graphic, Color>();
        ...
        void UpdateColor()
        {
            ...
            {
                if(!initialColors.ContainsKey(graphic))
                {
                    initialColors.Add(graphic, graphic.color);
                }

                Color initialColor = initialColors[graphic];
                graphic.color = initialColor * color;
            }
        }
